    ...
    def setUp(self):
        ...
        with engine.connect() as con:
            filename = os.path.join(
                Path(__file__).parent.parent, "db", "permission.sql"
            )
        ...
        self.signup1 = {"role_id": "1", "user_name": "manager1", "password": "manager1"}

        self.login_data1 = {"user_name": "admin", "password": "admin"}
